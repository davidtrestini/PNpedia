...
For spinning compact binaries on circular orbits (tidal effects included), we report here the relation between the waveform frequencies and orbital frequency.
