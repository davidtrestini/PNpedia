...
* the file ``angular_momentum_conservative.txt`` contains the conservative angular momentum in terms of the orbital frequency $x$
* the file ``angular_momentum_binding.txt`` contains the binding angular momentum in terms of the orbital frequency $x$
* the file ``angular_momentum_Schott.txt`` contains the Schott term in terms of the orbital frequency $x$
