# Energy for compact binaries on circular orbits expressed in terms of the orbital frequency

The energy associated to compact binaries on circular orbits is expressed in terms of the 
orbital frequency $\omega$ through the dimensionless variable $x=(G m \omega/c^3)^{2/3}$. 

The conservative energy is decomposed as follows:
* ``energy_NS_conservative.txt'' is the conservative energy for two nonspinning black holes
...
To obtain the binding energy, one should add the following contribution to the conservative energy:
* ``energy_Schott.txt'' is the Schott term
...
* for the spin-induced deformability sector:
    ...
    * ``\[CapitalDelta]\[Mu]p`` is defined as $\Delta\mu_+ = \frac{(\mu_1-1) + (\mu_2-1)}{2}$ (for black holes, $\Delta\mu_+=0$)
    * ``\[CapitalDelta]\[Mu]m`` is defined as $\Delta\mu_- = \frac{(\mu_1-1) - (\mu_2-1)}{2}$ (for black holes, $\Delta\mu_-=0$)
...
* in the spinning sector
   * in the spin-orbit sector in
        * (6.6a) of [arXiv:2608.31072v1](https://arxiv.org/abs/2608.31072v1)
        * (12) of [arXiv:2201.05138v1](https://arxiv.org/abs/2201.05138v1)
    * in the spin-spin sector in
        * (6.6b) of [arXiv:2608.31072v1](https://arxiv.org/abs/2608.31072v1)
        * (12) of [arXiv:2201.05138v1](https://arxiv.org/abs/2201.05138v1)
    * in the cubic-in-spin sector in
        * (6.6c) of [arXiv:2608.31072v1](https://arxiv.org/abs/2608.31072v1)
        * (5.18) of [arXiv:1411.4118v2](https://arxiv.org/abs/1411.4118v2)
    * in the quartic-in-spin sector (for black holes only) in
        * (6.6d) of [arXiv:2608.31072v1](https://arxiv.org/abs/2608.31072v1) [the 4PN contribution is vanishing]
...
* in the tidal sector:
    * at the $\text{N}^{2}\text{LO}$ in
        * (6.5b) of [arXiv:2005.13367v4](https://arxiv.org/abs/1912.01920)
