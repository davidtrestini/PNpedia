# Flux of angular momentum for compact binaries on circular orbits expressed in terms of the waveform frequency

The flux of angular momentum generated by compact binaries on circular orbits is expressed in terms of the waveform frequency $\omega_{22}$, defined here as the half-frequency of the (2,2) mode, through the dimensionless variable $x_{22}=(G m \omega_{22}/c^3)^{2/3}$.
...
The angular momentum flux for circular orbits is explicitly given (in terms of the waveform frequency $x22$):
* at 4.5PN
